...
from democ.lv1_clf import LV1UserDefinedClassifierMLP1700HiddenLayerCorrectLabels, \
...
if __name__ == '__main__':
    ...
    if len(sys.argv) < 3:
        print("usage: python clone.py lv1_targets/classifier_03.png output/image.png")
        exit(0)
    ...
    n = 100
    features = lv1_user_function_sampling_democracy(n_samples=n, exe_n=n, target_model=target)
